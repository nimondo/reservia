...
Second projet de la formation "Développeur Front-End" chez OpenClassroom. L'objectif de ce projet est d'intégrer une maquette en responsive HTML et CSS du site Réservia, outil de planification de vacances, de réservation d'hébergements et d'activités dans la ville de leur choix.
...
L'entête du site avec HEADER, le menu de navigation avec NAV, le contenu , les contenu indépendants avec ARTICLES, les balises SECTION pour un découpage plus précis, le pied de page avec FOOTER.
...
A noter que le responsive a été intégré directement dans le fichier CSS "style.css"
...
Le code a été versionner sur GIT et déployé sur GITHUB a l'addresse suivante https://alevsametoglu.github.io/Reservia/
